...
from .views import TaskCreateUpdateDeleteView, TaskAssignedToMeListView, TaskReviewingListView, TaskCreateCommentView
...
urlpatterns = [
    ...
    path("tasks/<int:task_id>/comments/", TaskCreateCommentView.as_view(), name="task-create-comment-view"),
